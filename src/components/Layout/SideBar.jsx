        ...
        >
          ...
          <Box>
            <Menu menuItemStyles={menuStyles}>
              ...
              <MenuItem
                style={navLinkStyles}
                component={<NavLink to="/departments" />}
              ...
              <MenuItem
                style={navLinkStyles}
                component={<NavLink to="/faculties" />}
                icon={<BusinessCenterIcon />}
              >
                {!isMobile && "Faculties"}
              </MenuItem>
              ...
              <MenuItem
                style={navLinkStyles}
                component={<NavLink to="/add-facultie" />}
                icon={<BusinessCenterIcon />}
              >
                {!isMobile && "Add Faculties"}
              </MenuItem>

              <MenuItem
                style={navLinkStyles}
                component={<NavLink to="/terms" />}
                icon={<BusinessCenterIcon />}
              >
                {!isMobile && "Terms"}
              </MenuItem>
